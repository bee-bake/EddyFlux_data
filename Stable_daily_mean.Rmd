...
oneday_48 <- hh_flux_noNA %>% filter(date == "2020-04-21")
...
#Plot the function
f <- function(x_p) {
  return(8.0376097 -0.7183182*x_p + 0.0251694*x_p^2 -0.0002902*x_p^3)
}
dat <- tibble(x_p, f_p)
...
d1 <- D(expression(8.0376097 -0.7183182*x + 0.0251694*x^2 -0.0002902*x^3), "x")
d2 <- D(d1, "x")

#find y-values
for (i in length(x)) {
  y = ((0.0251694 * 2 - 0.0002902 * (3 * (2 * x))))
}
