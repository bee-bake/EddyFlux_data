...
model_flux <- psem(
  ...
  lm(daily_CH4 ~ Wind + iCH4_1.6m + iCH4_5m + DOsat_5m, data_flux)
...
model_flux <- '
  ...
  daily_CH4 ~ Wind + iCH4_1.6m + iCH4_5m + DOsat_5m 
  iCH4_9m ~~  iCH4_1.6m
  iCH4_5m ~~  iCH4_1.6m
'
...
model_flux <- psem(
  ...
  lm(iCH4_5m ~ DOsat_5m + iCH4_9m + mean_fDOM, data_flux),
  lm(iCH4_1.6m ~ Wind + DOsat_1.6m + mean_Chla + sch_stab + iCH4_9m + iCH4_5m, data_flux),
  lm(daily_CH4 ~ Wind + iCH4_1.6m + mean_Chla + iCH4_9m + DOsat_9m, data_flux)
...
model_flux <- '
  ...
  iCH4_5m ~ DOsat_5m + iCH4_9m + mean_fDOM
  iCH4_1.6m ~ Wind + DOsat_1.6m + mean_Chla + sch_stab + iCH4_9m + iCH4_5m
  daily_CH4 ~ Wind + iCH4_1.6m + mean_Chla + iCH4_9m + DOsat_9m
  iCH4_9m ~~  iCH4_1.6m
  iCH4_5m ~~  iCH4_1.6m
'
