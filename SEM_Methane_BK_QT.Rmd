...
data_flux <- epi_hyp_int |> 
  select(DOsat_9m, temp_1.6m, temp_9m, 
         ...
         iCH4_3.8m, temp_5m, iCH4_surface) |> 
  na.omit()
...
model_flux <- '
  ...
  iCH4_1.6m ~ DOsat_1.6m + mean_Chla + temp_1.6m
...
model_flux <- psem(
  ...
  lm(iCH4_9m ~ DOsat_9m + sch_stab, data_flux),
  lm(iCH4_5m ~ DOsat_5m + mean_fDOM + iCH4_9m, data_flux),
  lm(iCH4_1.6m ~ DOsat_1.6m + iCH4_5m + sch_stab + DOsat_5m + mean_Chla + iCH4_9m, data_flux),
...
model_flux <- '
  ...
  iCH4_5m ~ DOsat_5m + mean_fDOM + iCH4_9m 
  iCH4_1.6m ~ DOsat_1.6m + iCH4_5m + sch_stab + DOsat_5m + mean_Chla + iCH4_9m 
