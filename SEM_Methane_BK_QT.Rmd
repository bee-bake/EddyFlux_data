...
data_flux <- epi_hyp_int |> 
  select(DOsat_9m, temp_1.6m, temp_9m, 
...
model_flux <- psem(
  lm(sch_stab ~ temp_9m, data_flux),
  lm(DOsat_9m ~ sch_stab, data_flux),
  lm(iCH4_9m ~ DOsat_9m + temp_9m, data_flux)
...
model_flux <- psem(
  lm(DOsat_1.6m ~  mean_Chla + temp_1.6m, data_flux),
  lm(mean_Chla ~ temp_1.6m, data_flux),
  lm(iCH4_1.6m ~ DOsat_1.6m + mean_Chla + temp_1.6m, data_flux)
...
model_flux <- '
  ...
  iCH4_1.6m ~ DOsat_1.6m + mean_Chla + sch_stab + iCH4_9m + iCH4_5m
...
model_flux <- psem(
  ...
  lm(iCH4_1.6m ~ DOsat_1.6m + mean_Chla + sch_stab + iCH4_9m, data_flux),
  lm(daily_CH4 ~ Wind + iCH4_1.6m + temp_1.6m + mean_Chla + iCH4_5m + DOsat_1.6m, data_flux)
...
model_flux <- '
  ...
  iCH4_1.6m ~ DOsat_1.6m + mean_Chla + sch_stab + iCH4_9m 
  daily_CH4 ~ Wind + iCH4_1.6m + temp_1.6m + mean_Chla + iCH4_5m + DOsat_1.6m
'
...
model_flux <- psem(
  lm(DOsat_1.6m ~  mean_Chla, data_flux),
  lm(iCH4_1.6m ~ DOsat_1.6m + mean_Chla + sch_stab + iCH4_9m, data_flux),
  lm(daily_CH4 ~ Wind + iCH4_1.6m + temp_1.6m + mean_Chla + iCH4_9m + DOsat_1.6m, data_flux)
...
model_flux <- '
  DOsat_1.6m ~  mean_Chla
  iCH4_1.6m ~  DOsat_1.6m + mean_Chla + sch_stab + iCH4_9m
  daily_CH4 ~ Wind + iCH4_1.6m + temp_1.6m + mean_Chla + iCH4_9m + DOsat_1.6m
'
